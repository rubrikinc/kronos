...
import (
	...
	"github.com/scaledata/etcd/pkg/mock/mockstore"
	"github.com/scaledata/etcd/pkg/mock/mockwait"
...
func TestConcurrentApplyAndSnapshotV3(t *testing.T) {
	...
	for k := 1; k <= 101; k++ {
		...
		ent := sdraftpb.Entry{Index: uint64(idx), Data: pbutil.MustMarshal(req)}
